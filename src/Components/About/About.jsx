  ...
  return (
    <div className='about' >
      <div className="about-left">
          <img src={about} alt="" className='left' />
          <img src={play_icon} alt="" className='play' onClick={()=>{setPlayState(true)}} />
      </div>
      <div className="about-right">
        ...
        <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader, our diverse range of programs offers the perfect
